...
- 系统管理员：`admin / 123456`
- 活动管理员：`actadmin / 123456`、`actadmin2 / 123456`
- 学生：`stu01 / 123456`、`stu02 / 123456`、`stu03 / 123456`（其余学生同密码）
...
7. `stu01` 登录 -> 个人中心：编辑联系方式、上传头像、修改密码
8. `admin` 登录 -> 角色权限管理：新建角色并分配菜单/接口权限
9. 使用新角色账号登录 -> 左侧菜单按配置变化
10. `actadmin/admin` 登录 -> 数据分析：查看图表变化
